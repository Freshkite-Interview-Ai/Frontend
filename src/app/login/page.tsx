      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/80 dark:bg-secondary-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-secondary-200/50 dark:border-secondary-700/50 p-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 rounded-2xl border border-secondary-200 dark:border-secondary-700 bg-secondary-50/70 dark:bg-secondary-700/40 p-1">
              <button
                type="button"
