        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-secondary-900">InterviewPrep</span>
            </div>
            <Link
              href="/login"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-secondary-900 leading-tight">
              Ace Your Next
              <span className="text-primary-600"> Technical Interview</span>
            </h1>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="#features"
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-secondary-300 text-secondary-700 font-semibold rounded-xl hover:border-primary-600 hover:text-primary-600 transition-all text-lg"
              >
                Learn More
              </Link>
            </div>
          ...
          <section id="features" className="mt-32">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Feature 1 */}
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-secondary-100 hover:shadow-lg transition-shadow">
